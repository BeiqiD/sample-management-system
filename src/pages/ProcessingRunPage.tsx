...
import type { PlanUpdatePreview, SampleDetail, SampleSummary } from "../../shared/types";
...
export function ProcessingRunPage() {
  ...
  return <div className="page processing-run-page sample-page">
